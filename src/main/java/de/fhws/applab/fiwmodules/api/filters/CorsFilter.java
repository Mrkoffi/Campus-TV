...
package de.fhws.applab.fiwmodules.api.filters;
...
public class CorsFilter implements ContainerResponseFilter
{
	...
	{
		System.out.println( "Im CORS Filter" );
		try
		{
			containerResponseContext.getHeaders( ).putSingle( "Access-Control-Expose-Headers", "Link,Location" );
